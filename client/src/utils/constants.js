...
export const MESSAGES__ROUTES = 'api/messages';
export const GET_ALL_MESSAGES_ROUTES = `${MESSAGES__ROUTES}/get-messages`;
export const UPLOAD_FILE_ROUTE = `${MESSAGES__ROUTES}/upload-file`;
